...
<p class="alert d-inline-block alert-primary"><strong>SOC Note: </strong> SOC Note: if amendment 4 falls then amendments 5, 6, 8 and 27 also fall</p>
...
<p class="alert d-inline-block alert-primary"><strong>SOC Note: </strong> SOC Note: if amendment 13 falls then amendments 14, 15, 21, 22, 23, 24, 26 and 28 also fall</p>
...
<p class="alert d-inline-block alert-primary"><strong>SOC Note: </strong> SOC Note: The text which has been struck through below was found to be Out of Order since it creates an ambiguity within the motion</p>
...
If Amendment 13 has been accepted, replace the acronym ‘GPRC’ with the acronym ‘GPEx’.

New text reads:

v. The International Committee is a working group of GPEx.
